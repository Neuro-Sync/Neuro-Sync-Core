...
class MindwaveMobile2 {
  ...
  final EventChannel _aiDetectedMovementChannel =
      const EventChannel("$NAMESPACE/AIDetectedMovement");
  ...
  /// Stream for receiving updates on AI detected movement.
  ///
  /// emits action value whenever AI detects movement
  Stream<int> onAIDetectedMovement() {
    return _aiDetectedMovementChannel
        .receiveBroadcastStream()
